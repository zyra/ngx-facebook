...
(function (factory) {
    ...
    var FBVideoComponent = /** @class */ (function (_super) {
        ...
        FBVideoComponent.ɵfac = function FBVideoComponent_Factory(t) { return new (t || FBVideoComponent)(i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(i0.Renderer2)); };
        FBVideoComponent.ɵcmp = i0.ɵɵdefineComponent({ type: FBVideoComponent, selectors: [["fb-video"]], inputs: { href: "href", allowfullscreen: "allowfullscreen", autoplay: "autoplay", width: "width", showText: "showText", showCaptions: "showCaptions" }, outputs: { startedPlaying: "startedPlaying", paused: "paused", finishedPlaying: "finishedPlaying", startedBuffering: "startedBuffering", finishedBuffering: "finishedBuffering", error: "error" }, features: [i0.ɵɵInheritDefinitionFeature], decls: 0, vars: 0, template: function FBVideoComponent_Template(rf, ctx) { }, encapsulation: 2 });
        __decorate([
    ...
    /*@__PURE__*/ (function () { i0.ɵsetClassMetadata(FBVideoComponent, [{
            ...
            args: [{
                ...
                type: core_1.Output
            }], play: [], pause: [], seek: [], mute: [], unmute: [], isMuted: [], setVolume: [], getVolume: [], getCurrentPosition: [], getDuration: [] }); })();
});
